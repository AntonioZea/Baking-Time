...
public class WidgetUpdateService extends IntentService {
    ...
    public static final String UPDATE_RECIPE_LIST_SERVICE = "quagem.com.uba.action_update_list";
    ...
    public static void startActionUpdateList(Context context) {
        ...
        intent.setAction(UPDATE_RECIPE_LIST_SERVICE);
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (intent != null) {
            ...
            if (UPDATE_RECIPE_LIST_SERVICE.equals(action)) handleActionUpdateRecipeList();
        }
    }

    private void handleActionUpdateRecipeList() {
    ...
    private String jSon() {
        ...
        // TODO: 5/20/2018 this is temporary.
